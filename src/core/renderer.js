...
/**
 * 렌더러 초기화.
 * @param {HTMLCanvasElement} canvas - #game-canvas (960×640)
 */
 ...
 * @param {(ctx: CanvasRenderingContext2D) => void} drawFn - 상태 변경 금지
 */
 ...
 * @param {number} dx @param {number} dy - px. (0,0)이 기본
 */
