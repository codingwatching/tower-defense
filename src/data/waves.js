...
/**
 * 성장 곡선: hpMultiplier = 1.18^(n-1) (td-balance-design 권장 하한 — 실엔진 보정 D9-1).
...
export const WAVES = [
  ...
  { // W7 — 브루트 증편 + 고블린 물량 협공
    ...
    groups: [
      ...
      { enemy: 'goblin', count: 12, interval: 0.6, delay: 3 }
    ]
  },
  { // W8 — 전 종 혼합 러시 1
    hpMultiplier: 3.19,
    bonus: 70,
    groups: [
      { enemy: 'goblin', count: 14, interval: 0.6, delay: 0 },
      { enemy: 'orc', count: 7, interval: 1.3, delay: 2 },
      { enemy: 'wasp_runner', count: 7, interval: 0.9, delay: 6 }
    ]
  },
  { // W9 — 전 종 혼합 러시 2: 최종 점검
    ...
    groups: [
      ...
      { enemy: 'wasp_runner', count: 8, interval: 0.8, delay: 5 },
      { enemy: 'goblin', count: 8, interval: 0.6, delay: 9 }
    ]
  },
  { // W10 — 스톤 골렘 + 소수 호위 (보스전)
    hpMultiplier: 4.44,
